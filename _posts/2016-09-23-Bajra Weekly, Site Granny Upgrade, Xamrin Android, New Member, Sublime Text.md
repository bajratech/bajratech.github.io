...
**Site Granny**<br>
As we know **Bajra** has released it's own product <a href="https://sitegranny.com/" target="_blank">***Site Granny*** </a>, it was built on *Rails 4*, now it has been upgraded to *Rails 5* with a new feature ***Action Cable*** for web socket implementation.
{% include image.html
